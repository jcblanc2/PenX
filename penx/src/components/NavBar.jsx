...
const NavBar = ({ writing, handlePublish }) => {
    ...
    return (
        <header className="flex pt-2 justify-between items-center">
            ...
            <nav className="flex gap-7">
                {name && (
                    <>
                        {!writing && (<svg width="24" height="24" className=' cursor-pointer' onClick={handleCreatePost} clipRule="evenodd" fillRule="evenodd" strokeLinejoin="round" strokeMiterlimit="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        {writing && (<button className=' bg-green-400 hover:bg-green-500 focus:bg-green-500 text-white font-semibold rounded-full px-2 py-1' onClick={handlePublish}>Publish</button>)}
